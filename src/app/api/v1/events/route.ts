...
/**
 * GET /api/v1/events — Server-Sent Events stream of the caller's tenant events
 * (docs/clickup-transformation/05-api-spec.md). Clients (TanStack Query) invalidate
 * caches on the events they care about; the Inbox badge listens here too.
 */
